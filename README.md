...
>Thanks [@qjebbs](https://github.com/qjebbs) for his great job, I often use [Sketch Meaxure](https://github.com/qjebbs/sketch-meaxure) to export design specifications to co-workers. But there is one thing that bothers me. If a layer is locked, then it can't be measured. So I need to unlock all layers before spec export.
>
